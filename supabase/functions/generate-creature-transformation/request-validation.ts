import type { AdoptCreatureTransformationRequest, CreatureTransformationRequest, GenerateUnlockedTransformationRequest, GetCreatureVisualProgressRequest, GetCurrentCreatureVisualRequest, GetGameCreatureVisualsRequest, GetTransformationRequestStatusRequest, RollbackCreatureVisualVersionRequest, SubmitBackgroundRemovalCandidateRequest } from '../../../shared/creature-transformations/contracts.ts'
