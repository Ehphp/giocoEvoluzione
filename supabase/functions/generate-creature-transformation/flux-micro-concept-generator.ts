...
export function composeFluxMicroConceptInstructions(
    ...
    const secondaryAdaptationRule = structural
        ...
        : tailPresentationLock
          ? 'Introduce a secondary adaptation only when it is necessary for local anatomical continuity, tail-root integration or tightly linked target material or colour propagation. A secondary adaptation must be subordinate, less visually prominent and clearly derived from the primary mutation; never add one by default, rebalance posture, change stance, redistribute weight, redesign the torso or neck, reposition limbs or change overall body presentation.'
        : 'Introduce a secondary adaptation only when it is necessary for local anatomical continuity, target-root integration, minimal local proportion adjustment within the existing pose, local structural integration or tightly linked visual propagation. A secondary adaptation must be subordinate, less visually prominent and clearly derived from the primary mutation; never add one by default, rebalance posture, change stance, redistribute weight, reposition the head, torso or limbs, or change pose, facing, orientation, viewpoint, composition or overall body presentation.'
