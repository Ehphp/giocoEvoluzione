...
export function falImageModelProfile(): Readonly<{ imageSize: { width: number, height: number }, maxImageBytes: number, maxDecodedPixels: number }> {
    return Object.freeze({ imageSize: FAL_SEEDREAM_IMAGE_SIZE, maxImageBytes: 30 * 1024 * 1024, maxDecodedPixels: 32_000_000 })
}
