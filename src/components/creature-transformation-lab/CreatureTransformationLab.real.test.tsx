...
describe('CreatureTransformationLab real image pilot UI', () => {
    ...
    beforeEach(() => {
        ...
        mocks.getStatus.mockReset().mockResolvedValue({
            ...
            result: { signedUrl: 'https://signed.example/real.png', expiresAt: '2026-08-02T12:05:00.000Z', width: 1024, height: 1536, mimeType: 'image/png', sha256: 'b'.repeat(64), assetReadiness: 'FINAL_ASSET', warnings: [] },
        })
    ...
    it('requires cost confirmation, starts one REAL request and renders the validated terminal status', async () => {
        ...
        expect(container.textContent).toContain('FINAL_ASSET')
        expect(container.textContent).not.toContain('RAW_RESULT_ALPHA_MISSING')
