...
/**
 * The lineage no longer reaches the image prompt: the locked Seedream shell is deliberately
 * lineage-free and the continuity text is consumed by the micro-concept generator instead. These
