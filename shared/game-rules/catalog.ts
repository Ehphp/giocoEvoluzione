...
export const ROUND_EVENT_DEFINITIONS: RoundEventDefinition[] = [
    ...
    event('HEAT_SPIKE', 'Picco termico persistente', 'Calore costante e consumo energetico alto.', 'CLIMATE',
        ...
        { RESILIENCE: 'La protezione isolante peggiora la dissipazione.', MOBILITY: 'La mobilita aiuta a cercare riparo.', METABOLISM: 'La regolazione energetica sostiene lo stress termico.', AQUATIC: 'Le membrane favoriscono la termoregolazione.' }),
    event('NUTRIENT_COLLAPSE', 'Collasso risorse nutritive', 'Scarsita estesa nelle zone di foraggiamento.', 'ECOLOGICAL',
        { RESILIENCE: -1, MOBILITY: -1, SENSES: 0, METABOLISM: 2, AQUATIC: -1 },
        { RESILIENCE: 'La protezione ha un costo energetico.', MOBILITY: 'La ricerca rapida consuma risorse scarse.', METABOLISM: 'Un metabolismo efficiente riduce il consumo durante la carestia.', AQUATIC: 'La specializzazione acquatica trova poche risorse utili.' }),
